...
var flor,flor_running,flormuerta;

var venom,carnage,venomdie;

function preload(){
  trex_running =   loadAnimation("trex1.png","trex3.png","trex4.png");
  venomdie = loadImage("venom2.png");
...
/*  flor = loadImage("Flor1.png");
  flor2= loadImage("flor2.png");
  flor3 = loadImage("flor3.jpg");*/

  flor_running = loadAnimation("Flor1.png","flor2.png", "flor3.jpg");

  flormuerta = loadAnimation("flormuerta.png");
...
function setup() {
 ...
 //trex.addAnimation("running", flor_running);
  trex.addImage("collided", venomdie);
